...
public class CanPlaceFlowers_605 {
    ...
    public boolean canPlaceFlowers(int[] flowerbed, int n) {
        ...
        for (int i = 0; i < flowerbed.length; i++) {
            boolean condition = flowerbed[i] == 0 && (i == 0 || flowerbed[i - 1] == 0)
    ...
    public static void main(String[] args) {
        //
        CanPlaceFlowers_605 obj = new CanPlaceFlowers_605();
        System.out.println(obj.canPlaceFlowers(new int[]{0,1,0,1,0,1,0,0,0,0,0,1,0,0,1}, 3));
    }
}